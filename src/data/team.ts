...
export const teamMembers = [
  { 
    ...
    links: [
        { label: 'Instagram', url: 'https://www.instagram.com/miguelslzzz/' }
    ],
  ...
  { 
    ...
    links: [
        { label: 'Instagram', url: 'https://www.instagram.com/pabl0.sp/' }
    ],
  ...
  { 
    ...
    links: [
        { label: 'Instagram', url: 'https://www.instagram.com/ereyes_magos/' }
    ],
