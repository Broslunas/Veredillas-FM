...
const RemoteStudio = ({ mode = 'guest', roomId: initialRoomId = '' }) => {
  ...
  const toggleShowLocalVideo = () => {
    if (showLocalVideo && activeVideo === 'local') {
        exitFullScreen();
    }
    ...
    <div className="rs-container" ref={containerRef}>
        ...
        <div className="rs-footer">
             <div className="rs-controls-bar">
                 ...
                 <button onClick={toggleShowLocalVideo} className={`rs-control-btn ${!showLocalVideo ? 'active-red' : ''}`} title={showLocalVideo ? "Ocultar vista local" : "Mostrar vista local"}>
                    {showLocalVideo ? (
